...
use crate::sfx::{MusicStore, SfxStore, make_lua_sfx_api};
...
impl ScriptEnvironment {
    ...
    pub fn init_game(
            ...
            self.lua
                .create_function(move |lua, (effect_type, props): (LuaString, Value)| {
                    let effect = match effect_type.as_bytes().deref() {
                        ...
                        b"RegenerateTerrain" => WorldEffect::RegenerateTerrain,
        ...
        // Sound effects
        globals.set("sfx", make_lua_sfx_api(&self.lua, sfx, Some(music))?)?;
